            ...
            <div className="contact-content1">
                <div className="contact-form1">
                    ...
                    <div className="contact-details">
                        ...
                        <p className="contact-details-p">Email: <a href="mailto:marriyaswanth42@gmail.com">marriyaswanth42@gmail.com</a></p>
                        <p className="contact-details-p">Mobile: <a href="tel:9866474481">9866474481</a></p>
                    </div>
                </div>
                ...
                <div style={{ textDecoration: 'none', overflow: 'hidden', maxWidth: '100%', width: '500px', height: '500px' }}>
                    <div id="g-mapdisplay" style={{ height: '100%', width: '100%', maxWidth: '100%' }}>
                        ...
                        src="https://www.google.com/maps/embed/v1/place?q=nagasuri+plaza+addanki&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
                        allowFullScreen
